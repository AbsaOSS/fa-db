...
// sbt "project faDBDoobie" ++2.12.17 "testOnly -- -n za.co.absa.fadb.IntegrationTestTag"

// run all except ones with defined tag
// sbt "project faDBDoobie" ++2.12.17 "testOnly -- -l za.co.absa.fadb.IntegrationTestTag"
